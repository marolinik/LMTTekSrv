...
async function main() {
  ...
  // Each PSU is 2000W, pricing is per unit (€238.90 per PSU)
  // Total price = quantity × unit price
  const powerOptions = [
    { name: '2x PSU (4000W)', spec: '2x 2000W PSU, 4000W total capacity for 1-2 GPUs', price: 477.80, capacity: 4000, psuCount: 2 },
    { name: '3x PSU (6000W)', spec: '3x 2000W PSU, 6000W total capacity for 3-4 GPUs', price: 716.70, capacity: 6000, psuCount: 3 },
    { name: '4x PSU (8000W)', spec: '4x 2000W PSU, 8000W total capacity for 5-6 GPUs', price: 955.60, capacity: 8000, psuCount: 4 },
    { name: '5x PSU (10000W)', spec: '5x 2000W PSU, 10000W total capacity for 7-8 GPUs', price: 1194.50, capacity: 10000, psuCount: 5 },
  ];

  // First, deactivate old PSU components
